...
inline static void kernel_k1(const int x,const int y,__PSGrid *q,__PSGrid *k1)
{
  if (5 <= x && 5 <= y && x < 100 - 5 && y < 100 - 5) {
    ((double *)(k1 -> p))[__PSGridGetOffset2D(k1,x,y)] = 0.0001 * (1.0 / ((double )100)) / (1.0 / ((double )100)) / (1.0 / ((double )100)) * (((double *)(q -> p))[__PSGridGetOffset2D(q,x + -1,y + 0)] + ((double *)(q -> p))[__PSGridGetOffset2D(q,x + 0,y + -1)] + ((double *)(q -> p))[__PSGridGetOffset2D(q,x + 1,y + 0)] + ((double *)(q -> p))[__PSGridGetOffset2D(q,x + 0,y + 1)] - 4.0 * ((double *)(q -> p))[__PSGridGetOffset2D(q,x + 0,y + 0)]);
  }
   else {
...
{
  if (5 <= x && 5 <= y && x < 100 - 5 && y < 100 - 5) {
    ((double *)(k3 -> p))[__PSGridGetOffset2D(k3,x,y)] = 0.0001 * (1.0 / ((double )100)) / (1.0 / ((double )100)) / (1.0 / ((double )100)) * (((double *)(q -> p))[__PSGridGetOffset2D(q,x + -1,y + 0)] + ((double *)(k2 -> p))[__PSGridGetOffset2D(k2,x + -1,y + 0)] / 2.0 + (((double *)(q -> p))[__PSGridGetOffset2D(q,x + 0,y + -1)] + ((double *)(k2 -> p))[__PSGridGetOffset2D(k2,x + 0,y + -1)] / 2.0) + (((double *)(q -> p))[__PSGridGetOffset2D(q,x + 1,y + 0)] + ((double *)(k2 -> p))[__PSGridGetOffset2D(k2,x + 1,y + 0)] / 2.0) + (((double *)(q -> p))[__PSGridGetOffset2D(q,x + 0,y + 1)] + ((double *)(k2 -> p))[__PSGridGetOffset2D(k2,x + 0,y + 1)] / 2.0) - 4.0 * (((double *)(q -> p))[__PSGridGetOffset2D(q,x + 0,y + 0)] + ((double *)(k2 -> p))[__PSGridGetOffset2D(k2,x + 0,y + 0)] / 2.0));
  }
   else {
...
void createHost(double *host)
{
  for (int i2 = 0; i2 < 100; ++i2) 
    for (int i1 = 0; i1 < 100; ++i1) {
      int c1 = i1 - 100 / 2;
      int c2 = i2 - 100 / 2;
      host[i1 + 100 * i2] = (c1 * c1 + c2 * c2 < 100?1.0 : 0.0);
    }
}
...
int main(int argc,char **argv)
{
  ...
  double *host = (double *)(malloc(sizeof(double ) * 100 * 100));
  createHost(host);
