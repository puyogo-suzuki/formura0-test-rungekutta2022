...
void formura_step(Formura0Navi* data)
{
  ...
  for(int i2 = 5, b2 = 5;i2 < 995; ++i2, ++b2) {
    for(int i1 = 5, b1 = 5;i1 < 995; ++i1, ++b1) {
      ...
      data->k16[b1 + b2 * 1000] = 0.1 * ((((data->q_prev[(i1 + 1) + i2 * 1000] + data->q_prev[(i1 + -1) + i2 * 1000]) + data->q_prev[i1 + (i2 + 1) * 1000]) + data->q_prev[i1 + (i2 + -1) * 1000]) - 4.0 * data->q_prev[i1 + i2 * 1000]);
    }
  }
  //--body end--//--body start--
  ...
  for(int i2 = 5, b2 = 5;i2 < 995; ++i2, ++b2) {
    for(int i1 = 5, b1 = 5;i1 < 995; ++i1, ++b1) {
      int32_t localVal_3 = 1000.0;
      data->k26[b1 + b2 * 1000] = 0.1 * (((((data->q_prev[(i1 + 1) + i2 * 1000] + data->k16[(b1 + 1) + b2 * 1000] / 2.0) + (data->q_prev[(i1 + -1) + i2 * 1000] + data->k16[(b1 + -1) + b2 * 1000] / 2.0)) + (data->q_prev[i1 + (i2 + 1) * 1000] + data->k16[b1 + (b2 + 1) * 1000] / 2.0)) + (data->q_prev[i1 + (i2 + -1) * 1000] + data->k16[b1 + (b2 + -1) * 1000] / 2.0)) - 4.0 * (data->q_prev[i1 + i2 * 1000] + data->k16[b1 + b2 * 1000] / 2.0));
    }
  }
  //--body end--//--body start--
  for(int i2 = 5, b2 = 5;i2 < 1000; ++i2, ++b2) {
  ...
  for(int i2 = 5, b2 = 5;i2 < 995; ++i2, ++b2) {
    for(int i1 = 5, b1 = 5;i1 < 995; ++i1, ++b1) {
      int32_t localVal_3 = 1000.0;
      data->k36[b1 + b2 * 1000] = 0.1 * (((((data->q_prev[(i1 + 1) + i2 * 1000] + data->k26[(b1 + 1) + b2 * 1000] / 2.0) + (data->q_prev[(i1 + -1) + i2 * 1000] + data->k26[(b1 + -1) + b2 * 1000] / 2.0)) + (data->q_prev[i1 + (i2 + 1) * 1000] + data->k26[b1 + (b2 + 1) * 1000] / 2.0)) + (data->q_prev[i1 + (i2 + -1) * 1000] + data->k26[b1 + (b2 + -1) * 1000] / 2.0)) - 4.0 * (data->q_prev[i1 + i2 * 1000] + data->k26[b1 + b2 * 1000] / 2.0));
    }
  }
  //--body end--//--body start--
  for(int i2 = 5, b2 = 5;i2 < 1000; ++i2, ++b2) {
  ...
  for(int i2 = 5, b2 = 5;i2 < 995; ++i2, ++b2) {
    for(int i1 = 5, b1 = 5;i1 < 995; ++i1, ++b1) {
      ...
      double localVal_66 = data->k36[b1 + b2 * 1000];
      data->q[i1 + i2 * 1000] = (localVal_8 + (((data->k16[b1 + b2 * 1000] / 6.0 + data->k26[b1 + b2 * 1000] / 3.0) + localVal_66 / 3.0) + 0.1 * (((((data->q_prev[(i1 + 1) + i2 * 1000] + data->k36[(b1 + 1) + b2 * 1000]) + (data->q_prev[(i1 + -1) + i2 * 1000] + data->k36[(b1 + -1) + b2 * 1000])) + (data->q_prev[i1 + (i2 + 1) * 1000] + data->k36[b1 + (b2 + 1) * 1000])) + (data->q_prev[i1 + (i2 + -1) * 1000] + data->k36[b1 + (b2 + -1) * 1000])) - 4.0 * (localVal_8 + localVal_66)) / 6.0));
    }
  }
  //--body end--//--body start--
  for(int i2 = 5, b2 = 5;i2 < 1000; ++i2, ++b2) {
...
int formura_initialize(Formura0Navi* data){
  if((data->k16 = (double *)malloc(sizeof(double)*1000000)) == 0)
    return 0;
  if((data->q = (double *)malloc(sizeof(double)*1000000)) == 0)
    return 0;
  if((data->q_prev = (double *)malloc(sizeof(double)*1000000)) == 0)
    return 0;
  if((data->k26 = (double *)malloc(sizeof(double)*1000000)) == 0)
    return 0;
  if((data->k36 = (double *)malloc(sizeof(double)*1000000)) == 0)
    return 0;
