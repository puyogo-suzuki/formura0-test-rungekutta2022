...
void formura_step(Formura0Navi* data)
{
  ...
  for(int i1 = 4;i1 < 100; ++i1) {
    ...
    double localVal_10 = (localVal_1 - localVal_0) * 1.0e-3 / 1.0e-2;
    double localVal_14 = data->q_prev[(i1 + -2)];
    double localVal_19 = (localVal_1 + (localVal_14 - localVal_1) * 1.0e-3 / 1.0e-2 / 2.0);
    double localVal_22 = (localVal_19 - (localVal_0 + localVal_10 / 2.0)) * 1.0e-3 / 1.0e-2;
    double localVal_25 = data->q_prev[(i1 + -3)];
    double localVal_30 = (localVal_14 + (localVal_25 - localVal_14) * 1.0e-3 / 1.0e-2 / 2.0);
    double localVal_35 = (localVal_1 + (localVal_30 - localVal_19) * 1.0e-3 / 1.0e-2 / 2.0);
    double localVal_38 = (localVal_35 - (localVal_0 + localVal_22 / 2.0)) * 1.0e-3 / 1.0e-2;
